...
export const AboutDirectors: React.FC = () => {
  return (
    <section className="bg-jungle-green pt-[88px] pb-[116px] px-[24px] relative overflow-hidden md:pt-[100px] md:pb-[128px]">
      <img
      ...
      <div className="flex flex-col gap-[52px] items-center pt-[48px] md:flex-row md:flex-wrap md:justify-center md:gap-[11px] md:w-[573px] md:mx-auto">
        {directors.map((director) => (
          <Card className="md:mb-[65px]">
        ...
        <Card avatar={false} className="md:hidden">
        ...
        <Card avatar={false} className="hidden md:block">
          <div className="text-center pt-[35px]">
