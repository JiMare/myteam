  ...
  return (
    <section className="bg-green">
      <div className="px-[24px] mb-[97px] md:mb-[156px] xl:flex xl:items-end xl:justify-between xl:px-[165px]">
        ...
        <ParagraphBig className="text-center max-w-[324px] mx-auto md:w-[457px] xl:relative xl:text-left xl:max-w-[430px] xl:mx-0 xl:pt-[80px] xl:after:content-[''] xl:after:h-[4px] xl:after:w-[50px] xl:after:absolute xl:after:bg-light-blue xl:after:top-0 xl:after:left-0">
