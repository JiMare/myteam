...
export const StartSection: React.FC = () => {
  ...
  return (
    <section className="bg-orange relative py-[83px] text-center overflow-hidden">
      <HeadingLarge className="text-sacramento-green max-w-[320px] text-center mx-auto mb-[24px]">
